...
class InterpolateDiscrete:
    ...
    def predict_hazard(self, input, batch_size=256, numpy=None, eval_=True, to_cpu=False, num_workers=0):
        raise NotImplementedError

    def predict_pmf(self, input, batch_size=256, numpy=None, eval_=True, to_cpu=False, num_workers=0):
        raise NotImplementedError

    def predict_surv(self, input, batch_size=256, numpy=None, eval_=True, to_cpu=False, num_workers=0):
    ...
    def _surv_const_pdf(self, input, batch_size=256, numpy=None, eval_=True, to_cpu=False,
                        num_workers=0):
        ...
        s = self.model.predict_surv(input, batch_size, False, eval_, to_cpu, num_workers).float()
        n, m = s.shape
        device = s.device
    ...
    def predict_surv_df(self, input, batch_size=256, eval_=True, to_cpu=False, num_workers=0):
...
class InterpolatePMF(InterpolateDiscrete):
    ...
    def _surv_const_pdf(self, input, batch_size=256, numpy=None, eval_=True, to_cpu=False, num_workers=0):
...
class InterpolateLogisticHazard(InterpolateDiscrete):
    ...
    def _hazard_const_haz(self, input, batch_size=256, numpy=None, eval_=True, to_cpu=False,
                          num_workers=0):
    ...
    def _surv_const_haz(self, input, batch_size=256, numpy=None, eval_=True, to_cpu=False, num_workers=0):
